...
context.fillText("APERTE QUALQUER TECLA PARA COMEÇAR", canvas.width / 2, canvas.height * 0.58);
...
function update () {
	...
	if (textAlpha >= 0) {
		...
		context.textAlign   = "center";
		context.textBaseline = "middle";
		context.fillText("APERTE QUALQUER TECLA PARA COMEÇAR DENOVO", canvas.width / 2, canvas.height * 0.5);
		document.addEventListener("keydown", newGame);
